...
const testTemplate = fakeItemTemplate
    + '<xma-treeview-item [item]="item" [template]="itemTemplate" (checkedChange)="checkedChange($event)"></xma-treeview-item>';
...
describe('TreeviewItemComponent', () => {
    ...
    describe('item', () => {
        it('should not have element with class "treeview-item" if no item provided', () => {
            const fixture = createTestComponent('<xma-treeview-item></xma-treeview-item>');
        ...
        it('should have element with class "treeview-item" if binding item', () => {
            ...
            const fixture = createTestComponent('<xma-treeview-item [item]="item"></xma-treeview-item>');
            fixture.detectChanges();
            const element = fixture.debugElement.query(By.css('.treeview-item'));
