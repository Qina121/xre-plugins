function canvasP(canvas, ctx , width, height){
...
dots.forEach(function(dot) {
    ...
    ctx.fillRect(dot.x - 1, dot.y - 1, 1, 1);
    // 循环比对粒子间的距离
    ...
    if (dis < d2.max) {
        ...
        ctx.strokeStyle = 'rgba(36,215,70,' + (ratio + 0.2) + ')';
